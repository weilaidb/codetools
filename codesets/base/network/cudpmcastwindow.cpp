...
#include "ui_udpmcast.h"
#include    <QtNetwork>

QString CUdpMcastWindow::getLocalIP()
{
...
CUdpMcastWindow::CUdpMcastWindow(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::UdpMcastWindow)
{
    ui->setupUi(this);
...
CUdpMcastWindow::~CUdpMcastWindow()
{
    udpSocket->abort();
    delete udpSocket;
    delete ui;
...
void CUdpMcastWindow::onSocketStateChange(QAbstractSocket::SocketState socketState)
{
    switch(socketState)
    {
...
void CUdpMcastWindow::onSocketReadyRead()
{//读取数据报
...
void CUdpMcastWindow::on_actStart_triggered()
{//加入组播
...
void CUdpMcastWindow::on_actStop_triggered()
{//退出组播
...
void CUdpMcastWindow::on_actClear_triggered()
{
    ui->plainTextEdit->clear();
}

void CUdpMcastWindow::on_actHostInfo_triggered()
{
    QString hostName=QHostInfo::localHostName();//本地主机名
...
void CUdpMcastWindow::on_btnMulticast_clicked()
{//发送组播消息
