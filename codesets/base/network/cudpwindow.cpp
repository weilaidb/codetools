...
CUdpWindow::CUdpWindow(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::UdpWindow)
{
    ui->setupUi(this);
...
void CUdpWindow::onSocketStateChange(QAbstractSocket::SocketState socketState)
{
    switch(socketState)
    {
...
void CUdpWindow::onSocketReadyRead()
{//读取收到的数据报
...
void CUdpWindow::on_actStart_triggered()
{//绑定端口
...
void CUdpWindow::on_actStop_triggered()
{//解除绑定
...
void CUdpWindow::on_actClear_triggered()
{
    ui->plainTextEdit->clear();
}

void CUdpWindow::on_btnSend_clicked()
{//发送消息 按钮
...
void CUdpWindow::on_actHostInfo_triggered()
{//本机地址 按钮
    QString hostName=QHostInfo::localHostName();//本地主机名
...
void CUdpWindow::on_btnBroadcast_clicked()
{ //广播消息 按钮
