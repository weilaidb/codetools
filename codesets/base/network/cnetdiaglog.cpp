...
#include "ui_cnetdialog.h"
#include    <QHostInfo>
#include    <QNetworkInterface>



CNetDiaglog::CNetDiaglog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CNetDialog)
{
    ui->setupUi(this);
}

CNetDiaglog::~CNetDiaglog()
{
    delete ui;
}

void CNetDiaglog::lookedUpHostInfo(const QHostInfo &host)
{//查找主机信息的槽函数
...
void CNetDiaglog::on_btnGetHostInfo_clicked()
{//QHostInfo获取主机信息
    //    ui->plainTextEdit->clear();
...
void CNetDiaglog::on_btnDetail_clicked()
...
void CNetDiaglog::on_btnLookup_clicked()
{//查找主机信息
...
void CNetDiaglog::on_btnALLInterface_clicked()
...
QString CNetDiaglog::protocolName(QAbstractSocket::NetworkLayerProtocol protocol)
{//通过协议类型返回协议名称
    switch(protocol)
    {
...
void CNetDiaglog::on_btnClear_clicked()
{
    ui->plainTextEdit->clear();
}
