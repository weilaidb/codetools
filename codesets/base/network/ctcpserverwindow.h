#ifndef CTCPSERVERWINDOW_H
#define CTCPSERVERWINDOW_H
...
class CTcpServerWindow : public QMainWindow
{
    Q_OBJECT
...
public:
    explicit CTcpServerWindow(QWidget *parent = 0);
    ~CTcpServerWindow();
