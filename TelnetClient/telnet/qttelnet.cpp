...
void QtTelnetPrivate::parseSubTT(const QByteArray &data)
{
    ...
    const char c1[4] = { static_cast<char>(Common::IAC), static_cast<char>(Common::SB),
...
void QtTelnetPrivate::sendWindowSize()
{
    ...
    const char c[9] = { static_cast<char>(Common::IAC), static_cast<char>(Common::SB), Common::NAWS,
